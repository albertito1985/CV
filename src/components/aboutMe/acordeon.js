...
const AccordionDemo = ({changeImage}) => (
  <Accordion.Root className="AccordionRoot" type="single" defaultValue="item-1" collapsible onValueChange={changeImage}>
    ...
    <Accordion.Item className="AccordionItem"  value="item-4" >
      ...
      <AccordionContent>I live with my family in Åkersberga, Stockholm. In my free time I enjoy spending time with my family, reading, playing padel and football.</AccordionContent>
    </Accordion.Item>
  </Accordion.Root>
);
